...
export default class MainPage extends Component {
	...
	componentDidMount() {
		...
		fetch("https://api.themoviedb.org/3/movie/top_rated?api_key=4f2d813db1c216bca9c8a22d63ad274a&language=en-US&include_adult=false&include_video=false").then(response => response.json()).then(response => {
			...
			fetch("https://api.themoviedb.org/3/tv/top_rated?api_key=4f2d813db1c216bca9c8a22d63ad274a&language=en-US&include_adult=false&include_video=false").then(response => response.json()).then(response => {
				...
				fetch("https://api.themoviedb.org/3/person/popular?api_key=4f2d813db1c216bca9c8a22d63ad274a&language=en-US&page=1").then(response => response.json()).then(response => {
...
<div className="cardinner">
						...
						fetch("https://api.themoviedb.org/3/discover/tv?api_key=4f2d813db1c216bca9c8a22d63ad274a&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false").then(response => response.json()).then(response => {
